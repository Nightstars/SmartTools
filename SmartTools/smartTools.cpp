...
#pragma region 初始化反汇编页面
		ui.textEdit_assemblyConsole->verticalScrollBar()->setStyleSheet("QScrollBar:vertical"
			"{"
			"width:8px;"
			"background:rgba(0,0,0,0%);"
			"margin:0px,0px,0px,0px;"
			...
			"{"
			"height:9px;width:8px;"
			"border-image:url(:/imgs/Resources/imgs/up.png);"
			"subcontrol-position:bottom;"
			"}"
			"QScrollBar::sub-line:vertical"
			"{"
			"height:9px;width:8px;"
			"border-image:url(:/imgs/Resources/imgs/down.png);"
			"subcontrol-position:top;"
			"}"
			"QScrollBar::add-line:vertical:hover"
			"{"
